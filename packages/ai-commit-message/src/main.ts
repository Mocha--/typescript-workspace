...
const response = await googleAI.models.generateContent({
  ...
  config: {
    systemInstruction: `write a git commit message less than 72 characters; if the ticket name with the pattern ${ticketNamePattern} can be found in the branch name, then prefix the message in the format of <ticket-name>:.`,
  },
});
